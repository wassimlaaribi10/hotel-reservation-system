...
class InvoiceUseCases {
    ...
    const roomRepo = new (require('../../infrastructure/repositories/RoomRepository'))();
    ...
    for (let i = 0; i < nights; i++) {
        ...
        // On utilise la méthode getPriceForDate qui doit retourner un nombre
        let price = await this.seasonalPriceRepo.getPriceForDate(room.type, nightDate);
        // Si aucun prix trouvé, utiliser 100 par défaut
    ...
    return await this.invoiceRepository.create(invoice, detailsJson);
}
